...
def get_root_path() -> Path:
    """Retourne le chemin racine du projet (dossier parent de src/)."""
...
def get_incoming_path() -> Path:
    """Retourne le chemin vers le dossier Incoming/."""
    return get_root_path() / "incoming"


def get_archive_path() -> Path:
    """Retourne le chemin vers le dossier Archive/."""
    return get_root_path() / "archive"
